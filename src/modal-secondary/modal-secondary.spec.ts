...
export class WithActiveModalCmpt {
  constructor(public activeModal: NgbActiveModalSecondary) {}
...
class TestComponent {
  name = 'World';
  openedModal: NgbModalSecondaryRef;
  show = true;
  ...
  constructor(private modalService: NgbModalSecondary) {}
...
@NgModule({
  ...
  imports: [CommonModule, NgbModalSecondaryModule.forRoot()],
